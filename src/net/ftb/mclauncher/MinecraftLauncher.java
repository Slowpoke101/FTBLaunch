...
public class MinecraftLauncher {
	public static Process launchMinecraft(String workingDir, String username, String password, String forgename, String rmax) throws IOException {
		...
		String customPath = Settings.getSettings().getJavaBinaryPath();
		
		String path = null;
		
		if (customPath.isEmpty())
				path = System.getProperty("java.home") + separator + "bin" + separator + "java" + (OSUtils.getCurrentOS() == OSUtils.OS.WINDOWS ? "w" : "");
		else
				path = customPath;
