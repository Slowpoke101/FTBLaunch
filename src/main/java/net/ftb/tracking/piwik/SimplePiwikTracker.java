...
public class SimplePiwikTracker implements PiwikTracker {
    ...
    public final void setApiurl(final URL apiurl) throws PiwikException {
        ...
        if (apiurl.getPath().endsWith("piwik.php") || apiurl.getPath().endsWith("piwik-proxy.php")) {
            ...
            try {
                ...
                Logger.logError("MalformedURLException", e);
            }
        }
    }
    ...
    public final String getGeneralQuery() {
        ...
        if (this.visitorCustomVar.isEmpty()) {
            ...
            Gson g = JsonFactory.GSON;
            String json = JsonFactory.GSON.toJson(customVariables);

            // remove unnecessary parent square brackets from JSON-string
            String jsonString = json.substring(1, json.length() - 1);
            //TODO make sure ^ works correctly w/ the GSON stuffs
        ...
        if (this.pageCustomVar.isEmpty()) {
            ...
            final Map<String, List<String>> customVariables = Maps.newHashMap();
            int i = 0;
    ...
    private String urlencode(final String input) {
        ...
        try {
            ...
            Logger.logError( "Error while encoding url", e);
            output = input;
        }
        return output;
    }
    ...
    private String md5(final String input) {
        ...
        try {
            ...
            Logger.logError("Error while creating a md5 hash", e);
        }
        return retVal;
    }
    ...
    public final URL getGoalTrackURL(final String goal) {
        ...
        try {
            ...
            Logger.logError("Error while building track url", e);
        }
        return output;
    }
